...
RUN	git clone https://github.com/amonbit-project/gitian.sigs.git sigs; \
  ...
  git clone https://github.com/amonbit-project/amonbit
...
if [ ! -d sigs ]; then
	git clone https://github.com/amonbit-project/gitian.sigs.git sigs
	cd sigs
