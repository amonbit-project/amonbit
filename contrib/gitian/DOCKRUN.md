...
*Setup instructions for a Gitian build of Amonbit using Docker.*
...
You'll also need to clone the amonbit repository and navigate to the `contrib/gitian` directory:

```bash
git clone https://github.com/amonbit-project/amonbit.git
cd amonbit/contrib/gitian
```
...
* a fork of the [gitian.sigs](https://github.com/amonbit-project/gitian.sigs/) repo on your GitHub account.
